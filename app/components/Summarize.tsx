...
const Summarize = () => {
  return (
    <section className="flex flex-col md:flex-row gap-10 md:gap-0 items-center bg-azure-blue p-10 lg:p-20 rounded-tr-3xl rounded-bl-3xl">
      <article className="md:w-1/2">
        <Image src="/images/summarize.png" width={500} height={500} alt="" />
      </article>
      <article className="md:w-1/2 text-cotton-white">
